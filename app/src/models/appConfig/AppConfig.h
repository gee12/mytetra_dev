...
public:
    ...
    // Получение имени файла, в котором хранится текущий конфиг
    // Данный метод нужен не для раскрытия значения, а только для того, чтобы
    // выводить в окне интерфейса информацию об используемой конфигурации
